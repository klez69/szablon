    ...
    <section class="services">
        ...
        <div class="service-card-horizontal">
                ...
                <div class="card-content">
                    ...
                    <p>Lista jednostek napędowych, które można poddać konwersji na zasilanie LPG z wykorzystaniem gazowego układu zasilania BRC Sequent Maestro jest coraz dłuższa. Dział rozwoju Westport Fuel Systems Italia opracowuje pod kątem zasilania LPG najbardziej popularne na rynku silniki z bezpośrednim wtryskiem benzyny.</p>
        ...
        <div class="service-card-horizontal">
                ...
                <div class="card-content">
                    ...
                    <p>Dział rozwoju Westport Fuel Systems pracuje pełną parą, czego wyrazem jest wydłużająca się lista opracowań instalacji BRC Sequent Maestro, która może być stosowana w coraz większej liczbie samochodów wyposażonych w silniki z bezpośrednim wtryskiem benzyny.</p>
            ...
            <div class="service-card-horizontal">
                ...
                <div class="card-content">
                    ...
                    <p>Firma Czakram, oficjalny przedstawiciel BRC na polskim rynku ma w ofercie nowy system zasilania gazowego do silników z bezpośrednim wtryskiem benzyny. Wszystkie nowe modele samochodów wyposażonych w silniki z bezpośrednim wtryskiem benzyny będą opracowywane na bazie instalacji BRC Sequent Maestro. ......</p>
            ...
            <div class="service-card-horizontal">
                ...
                <div class="card-content">
                    ...
                    <p>Warsztat Instal Autogaz z Poznania, posiadający także oddział w Lesznie, często montuje instalacje gazowe marki BRC i coraz częściej są to systemy do silników z bezpośrednim wtryskiem benzyny. Sztandarowym produktem BRC w tym segmencie jest instalacja Sequent Maestro.</p>
            ...
            <div class="service-card-horizontal">
                ...
                <div class="card-content">
                    ...
                    <p>Hybrydowe Toyoty uchodzą za znakomite auta pod kątem zasilania LPG. Do niedawna stosowane były w nich jednostki napędowe z pośrednim wtryskiem benzyny, które w bardzo prosty sposób można było dostosować do zasilania LPG. Czy obecnie, kiedy w hybrydach Toyoty stosowane są silniki z wtryskiem bezpośrednim coś się zmieniło?</p>
            ...
            <div class="service-card-horizontal">
                ...
                <div class="card-content">
                    ...
                    <p>Firma Czakram prezentuje wykonany montaż sekwencyjnej instalacji gazowej marki BRC Sequent Maestro w aucie Hyundai Tucson z silnikiem 1 6 T GDI o mocy 177 KM, rok produkcji 2019. Instalacja LPG – BRC Sequent Maestro Lubryfikacja .......</p>
