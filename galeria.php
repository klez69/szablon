            ...
            <div class="gallery-container">
                ...
                <div class="gallery-grid">
                    ...
                    <div class="gallery-item">
                        <div class="gallery-item-title">Toyota Sienna Hybrid AWD 2.5 [4cyl]</div>
                        <img src="images/2a.webp" alt="Instalacja LPG 1">
                        <div class="gallery-item-description">Zamontowała firma: CZAKRAM TARNÓW</div>
                    </div>
                    <div class="gallery-item">
                        <div class="gallery-item-title">Infinity Q60 [6cyl]</div>
                        <img src="images/2b.webp" alt="Instalacja LPG 2">
                        <div class="gallery-item-description">Zamontowała firma: CZAKRAM TARNÓW</div>
                    </div>
                    <div class="gallery-item">
                        <div class="gallery-item-title">Audi A4 B8 2.0 TFSI [4cyl]</div>
                        <img src="images/2c.webp" alt="Instalacja LPG 3">
                        <div class="gallery-item-description">Zamontowała firma: CZAKRAM TARNÓW</div>
                    </div>
                    <!-- Drugi rząd -->
                    <div class="gallery-item">
                        <div class="gallery-item-title">Jeep Renegade 1.3 GSE [4cyl]</div>
                    ...
                    <div class="gallery-item">
                        <div class="gallery-item-title">Audi SQ5 V6 TFSI [6cyl]</div>
                        <img src="images/2f.webp" alt="Instalacja LPG 6">
                        <div class="gallery-item-description">Zamontowała firma: CZAKRAM TARNÓW</div>
                    </div>
                    <!-- Trzeci rząd -->
                    <div class="gallery-item">
                        <div class="gallery-item-title">Porsche Macan 2.0 R4 [4cyl]</div>
                    ...
                    <div class="gallery-item">
                        <div class="gallery-item-title">Subaru Crosstrek 2 2.0 BOXER [4cyl]</div>
                        <img src="images/2h.webp" alt="Instalacja LPG 8">
                        <div class="gallery-item-description">Zamontowała firma: TECH - CAR</div>
                    </div>
                    <div class="gallery-item">
                        <div class="gallery-item-title">Mazda CX9II 2,5 R4 [4cyl]</div>
                    ...
                    <!-- Czwarty rząd -->
                    <div class="gallery-item">
                        <div class="gallery-item-title">Hyundai Ioniq 1.6L Hybrid [4cyl]</div>
                        <img src="images/2j.webp" alt="Instalacja LPG 7">
                        <div class="gallery-item-description">Zamontowała firma: </div>
                    </div>
                    <div class="gallery-item">
                        <div class="gallery-item-title">Toyota Yaris R3 125km [3cyl]</div>
                        <img src="images/2k.webp" alt="Instalacja LPG 8">
                        <div class="gallery-item-description">Zamontowała firma: CZAKRAM TARNÓW</div>
                    </div>
                    <div class="gallery-item">
                        <div class="gallery-item-title">Mazda CX5 2,5 194km [4cyl]</div>
                    ...
                    <!-- Piąty rząd -->
                    <div class="gallery-item">
                        <div class="gallery-item-title">Lincoln Navigator 3,5 V6 EcoBoost [6cyl]</div>
                        <img src="images/2m.webp" alt="Instalacja LPG 7">
                        <div class="gallery-item-description">Zamontowała firma: CZAKRAM TARNÓW</div>
                    </div>
                    <div class="gallery-item">
                        <div class="gallery-item-title">Volvo V60 T6 2.0 R4 [4cyl]</div>
                        <img src="images/2n.webp" alt="Instalacja LPG 8">
                        <div class="gallery-item-description">Zamontowała firma: CZAKRAM TARNÓW</div>
                    </div>
                    <div class="gallery-item">
                        <div class="gallery-item-title">VW Tiguan [4cyl]</div>
