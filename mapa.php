...
<head>
    ...
    <title>Mapa Zakładów BRC Maestro</title>
    
    <!-- SEO Meta Tags -->
    <meta name="description" content="Interaktywna mapa zakładów montażowych BRC Maestro w Polsce. Znajdź najbliższy punkt montażu instalacji LPG.">
    <meta name="keywords" content="BRC Maestro, zakłady montażowe, mapa Polski, instalacja LPG, montaż LPG">
                ...
                <div class="col-lg-12">
                    <div class="map-container">
                        <svg xmlns:mapsvg="http://mapsvg.com" 
                             ...
                             <a href="#" data-toggle="tooltip" data-placement="top" title="Dolnośląskie - odwiedziny: 7">
                        <path
                            ...
                            title="Dolnośląskie" id="PL-DS" class=" mapsvg-region" 
                            style="fill:rgb(252, 255, 68);"></path>
                    </a>
                    <a href="#" data-toggle="tooltip" data-placement="top" title="Kujawsko-Pomorskie">
                        <path
                            ...
                            title="Kujawsko-Pomorskie" id="PL-KP" class=" mapsvg-region"
                            style="fill:rgb(252, 255, 68);"></path>
                    </a>
                            
                    <a href="#" data-toggle="tooltip" data-placement="top" title="Łódzkie  ">
                        <path
                            ...
                            title="Łódzkie" id="PL-LD" class=" mapsvg-region"
                            style="fill:rgb(231, 163, 36);"></path>
                    </a>
                    <a href="#" data-toggle="tooltip" data-placement="top" title="Lubelskie  ">
                        <path
                            ...
                            title="Lubelskie" id="PL-LU" class=" mapsvg-region"
                            style="fill:rgb(0, 174, 255);"></path>
                    </a>
                    <a href="#" data-toggle="tooltip" data-placement="top" title="Lubuskie  ">
                        <path
                            ...
                            title="Lubuskie" id="PL-LB" class=" mapsvg-region"
                            style="fill:rgb(231, 163, 36);"></path>
                    </a>
                    <a href="#" data-toggle="tooltip" data-placement="top" title="Małopolskie  ">
                        <path
                            ...
                            title="Małopolskie" id="PL-MA" class=" mapsvg-region"
                            style="fill:rgb(0, 174, 255);"></path>
                    </a>
                    <a href="#" data-toggle="tooltip" data-placement="top" title="Mazowieckie  ">
                        <path
                            ...
                            style="fill:rgb(219, 71, 212);"></path>
                    </a>
                    <a href="#" data-toggle="tooltip" data-placement="top" title="Opolskie  ">
                        <path
                            ...
                            title="Opolskie" id="PL-OP" class=" mapsvg-region" 
                            style="fill:rgb(83, 219, 71);"></path>
                    </a>
                    <a href="#" data-toggle="tooltip" data-placement="top" title="Podkarpackie  ">
                        <path
                            ...
                            title="Podkarpackie" id="PL-PK" class=" mapsvg-region" style="fill:rgb(252, 255, 68);"></path>
                    </a>
                    <a href="#" data-toggle="tooltip" data-placement="top" title="Podlaskie  ">
                        <path
                            ...
                            title="Podlaskie" id="PL-PD" class=" mapsvg-region" style="fill:rgb(255, 153, 0);"></path>
                    </a>
                    <a href="#" data-toggle="tooltip" data-placement="top" title="Pomorskie  ">
                        <path
                            ...
                            title="Pomorskie" id="PL-PM" class=" mapsvg-region" style="fill:rgb(219, 71, 212);"></path>
                    </a>
                    <a href="#" data-toggle="tooltip" data-placement="top" title="Śląskie  ">
                        <path
                            ...
                            title="Śląskie" id="PL-SL" class=" mapsvg-region" style="fill:rgb(219, 71, 212);"></path>
                    </a>
                    <a href="#" data-toggle="tooltip" data-placement="top" title="Świętokrzyskie  ">
                        <path
                            ...
                            title="Świętokrzyskie" id="PL-SK" class=" mapsvg-region" style="fill:rgb(83, 219, 71);"></path>
                    </a>
                    <a href="#" data-toggle="tooltip" data-placement="top"
                        ...
                        <path
                            ...
                            title="Warmińsko-Mazurskie" id="PL-WN" class=" mapsvg-region" style="fill:rgb(83, 219, 71);"></path>
                    </a>
                    <a href="#" data-toggle="tooltip" data-placement="top" title="Wielkopolskie  ">
                        <path
                            ...
                            title="Wielkopolskie" id="PL-WP" class=" mapsvg-region" style="fill:rgb(0, 174, 255);"></path>
                    </a>
                    <a href="#" data-toggle="tooltip" data-placement="top"
                        ...
                        <path
                            ...
                            title="Zachodniopomorskie" id="PL-ZP" class=" mapsvg-region" style="fill:rgb(83, 219, 71);"></path>
                    </a>        
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.mapsvg-region').click(function(e) {
                e.preventDefault();
                let wojewodztwo = $(this).attr('title');
                window.location.href = 'zaklady.php?region=' + encodeURIComponent(wojewodztwo);
            });

            // Dodaj hover efekt
            $('.mapsvg-region').hover(
                function() {
                    $(this).css('fill', 'rgb(252, 255, 68)');
                },
                function() {
